    ...
    <div class="relative z-10 sm:mx-auto sm:w-full sm:max-w-md animate-slide-up">
        <div class="bg-white py-10 px-4 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-100 sm:rounded-3xl sm:px-10">
            ...
            <div class="text-center mb-8 animate-slide-up delay-200">
                ...
                <p class="text-sm text-slate-500 mt-2">Kelola jejak digital produk Anda.</p>
            </div>

            <form class="space-y-6 animate-slide-up delay-300" action="/login" method="POST">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="password" name="password" type="password" autocomplete="current-password" required class="block w-full rounded-xl border-0 py-3 px-4 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-green-500 sm:text-sm transition">
                    </div>
                </div>

                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <label for="remember-me" class="flex items-center gap-2 cursor-pointer group">
                            <div class="relative flex items-center justify-center">
                                <input id="remember-me" name="remember-me" type="checkbox" class="peer appearance-none w-5 h-5 border-2 border-slate-300 rounded bg-white checked:bg-green-500 checked:border-green-500 transition-all cursor-pointer shadow-sm">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-semibold text-green-600 hover:text-green-500 transition">Lupa sandi?</a>
                    </div>
                </div>
            ...
            <div class="mt-8 text-center text-sm text-slate-600 animate-slide-up delay-400">
                Belum punya akun? <a href="{{ route('register') }}" class="font-semibold text-green-600 hover:text-green-500 transition">Daftar di sini.</a>
            </div>
        </div>
    </div>
</body>
